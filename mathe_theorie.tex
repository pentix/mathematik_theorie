...
gewisse Probleme nicht mehr in den reellen Zahlen lösbar sind. Beispiele:
\begin{eqnarray*}
x^2+4 & = 0\\
x^2+4x+13 & = 0\\
x^2+1 & = 0
...
Ebene. Die x-Achse wird als die "reelle Achse" bezeichnet, wohin gehen,
die neue hinzugekommene y-Achse "imaginäre Achse" genannt wird.\\
\begin{figure}[t]
  \includegraphics[scale=2]{img/komplexe_zahlen.pdf}\\
  \caption{Eine reelle und eine komplexe Zahl in der kartesischen Darstellung}
\end{figure}
