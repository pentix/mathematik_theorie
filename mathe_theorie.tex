...
Zahlen haben nun also 2 Koordinaten. Dies kann wie folgt geschrieben werden:
\[(4, 3i) = 4 + 3i\]
...
\[\vert z \vert = r = \sqrt{Re(z)^2 + Im(z)^2} \]
...
Das $cis$ steht hierbei für $\cos$, $i$ und $\sin$, die trigonometrischen Funktionen, die bei der
Berechnung mit Polarkoordinaten gebraucht werden. Auf diese Berechnungen wird hier nicht
weiter eingegangen.\\
