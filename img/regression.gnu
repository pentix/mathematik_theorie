...
set xrange [ 0.00000 : 8.00000 ] noreverse nowriteback
...
f(x) = 0.196429*x*x + 0.236429*x + -0.0328571
g(x) = 1.80786*x + -2.39
h(x) = 0.363849 * exp(0.534248*x)
GNUTERM = "qt"
GPFUN_f = "f(x) = 0.196429*x*x + 0.236429*x + -0.0328571"
GPFUN_g = "g(x) = 1.80786*x + -2.39"
GPFUN_h = "h(x) = 0.363849 * exp(0.534248*x)"
plot "punkte" using 1:2 title "Punkte", f(x) title "Regressionsparabel", g(x) title "Regressionsgerade", h(x) title "Exponentielle Regressionsfunktion"
#    EOF
